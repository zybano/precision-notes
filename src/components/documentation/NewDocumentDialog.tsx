  ...
  const handleDownloadPDF = async () => {
    if (!printRef.current) {
      toast.error("Could not generate PDF", {
        description: "There was an error preparing your document."
      });
      return;
    }
    ...
    try {
      ...
      toast.success("PDF document ready", {
        description: "Your complete medical report has been downloaded."
      });
    } catch (error) {
      console.error("PDF generation error:", error);
      toast.error("Could not generate PDF", {
        description: "There was an error creating your PDF document."
      });
    }
  };
